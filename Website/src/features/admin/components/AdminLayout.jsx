...
export default function AdminLayout() {
  ...
  const adminMenuItems = [
    ...
    { id: 'facilities', label: 'Quản lý Chủ sân', icon: Building2, path: '/admin/facilities' },
    { id: 'payouts', label: 'Yêu cầu rút tiền', icon: Wallet, path: '/admin/payouts' },
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-[#0b0f19] text-gray-900 dark:text-gray-100 font-sans transition-colors duration-300 overflow-hidden">
      {/* Admin Sidebar */}
      <aside className="w-64 bg-white dark:bg-[#0b0f19]/90 border-r border-gray-100 dark:border-white/5 flex flex-col justify-between h-screen shrink-0 transition-colors duration-300">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden">
        {/* Header */}
        <header className="h-16 shrink-0 bg-white dark:bg-[#0b0f19] border-b border-gray-100 dark:border-white/5 flex items-center justify-between px-8">
          <div>
            <span className="text-xs font-bold text-gray-400 uppercase tracking-widest font-label">Trang Quản Trị</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold font-label dark:text-white">
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-gray-50 dark:bg-[#0e1322]">
          <Outlet />
        </div>
      </main>
    </div>
